...
#define BDD_FILE "bdd/robot_controller.bdd"
#define DCONTR_FILE "robot_contr_determinized.bdd"
#define C_FILE "robot_bdd_functions.h"
...
int main() {
	...
	converter.GenerateBooleanFunctions(C_FILE, true, 1);
